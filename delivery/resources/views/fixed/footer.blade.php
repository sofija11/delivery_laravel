                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="widget widget-payment">
                                <div class="wid-payment">
                                    <img class = "widget payment_image" src="{{ asset("images/paypal.png") }}" alt="">
                                </div>
                                <div class="wid-payment">
                                    <ul>
...
<!-- Mirrored from demo-9.mysitesweb.su/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Feb 2021 15:00:42 GMT -->
</html>